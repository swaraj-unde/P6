    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#FBBF24] flex items-center gap-2">
                <Plus size={24} className="text-[#FBBF24]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
                  ...
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                          ${
                            selectedTemplate === template.id
                              ? "border-[#FBBF24]  shadow-[0_0_0_1px_#FBBF24,0_8px_20px_rgba(233,63,63,0.15)]"
                              : "hover:border-[#FBBF24] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                          }
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#FBBF24] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#FBBF24]">
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#FBBF24,0_8px_20px_rgba(233,63,63,0.15)] rounded-lg border">
